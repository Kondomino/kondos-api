...
*/
    /*
        ...
        */
    async findMediasOfKondo(kondoId) {
        return await this.MediaRepository.findAll({ where: { kondoId } });
    }
    async findBy(searchMediaDto) {
        const { filename } = searchMediaDto;
        return await this.MediaRepository.findOne({ where: { filename } });
    }
    async findAll() {
